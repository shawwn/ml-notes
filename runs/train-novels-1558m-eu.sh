...
export TPU_NAME="${TPU_NAME:-tpu-v3-8-euw4a-202}"

export RUN_ID="${RUN_ID:-a}"
export RUN_NAME="${RUN_NAME:-novels02}"
export RUN_DESC="${RUN_DESC:-1558M novels run}"
...
export DATASET="${DATASET:-gs://dota-euw4a/datasets/novels.tok16}"
