...
export TPU_NAME="${TPU_NAME:-tpu-v2-8-usc1f-7}"

export GRADIENT_CHECKPOINTING=1

export RUN_ID="${RUN_ID:-c_checkpointing_01}"
export RUN_NAME="${RUN_NAME:-vanilla117m01}"
export RUN_DESC="${RUN_DESC:-117M vanilla gradient checkpointing run}"
